 ...
 * @source https://github.com/OILYY/BetterDiscordAddons/tree/master/Plugins/ThemeRepo/
 * @updateUrl https://OILYY.github.io/BetterDiscordAddons/Plugins/ThemeRepo/ThemeRepo.plugin.js
 */
				...
				const checkTheme = _ => {
					if (checksRunning > 20) return;
						...
						if (!callbackCalled) {
							...
							BDFDB.DiscordUtils.requestFileData("https://OILYY.github.io/BetterDiscordAddons/Plugins/ThemeRepo/_res/GeneratorList.txt", (error, buffer) => {
