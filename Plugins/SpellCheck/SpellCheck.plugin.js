 ...
 * @source https://github.com/OILYY/BetterDiscordAddons/tree/master/Plugins/SpellCheck/
 * @updateUrl https://OILYY.github.io/BetterDiscordAddons/Plugins/SpellCheck/SpellCheck.plugin.js
 */
		...
		return class SpellCheck extends Plugin {
			...
			setDictionary (key, lang) {
				...
				if (languages[lang]) {
					...
					else BDFDB.LibraryRequires.request("https://OILYY.github.io/BetterDiscordAddons/Plugins/SpellCheck/dic/" + lang + ".dic", (error, response, body) => {
